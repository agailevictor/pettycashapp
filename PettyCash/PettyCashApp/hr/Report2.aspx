<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report2.aspx.cs" Inherits="PettyCashApp.hr.Report2" MasterPageFile="~/hr/hr.Master" %>
                    ...
                    <form class="form-horizontal" runat="server" id="startj_form">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-4 col-sm-8">
                                <asp:Button ID="rpt_htry" runat="server" Text="Get Report" CssClass="btn btn-primary waves-light" ClientIDMode="Static" OnClick="rpt_htry_Click" OnClientClick="rpt_vali()" />
                            </div>
                        </div>
