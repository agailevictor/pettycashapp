<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dash.aspx.cs" Inherits="PettyCashApp.user.dash" MasterPageFile="~/user/user.Master" %>
            ...
            <div class="col-lg-12">
                <div class="card-box">
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="grd_latest" CssClass="table table-striped table-bordered dataTable no-footer" runat="server" AutoGenerateColumns="False">
                            <Columns>
